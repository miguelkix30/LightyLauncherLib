use crate::minecraft::loaders::lighty_updater::lighty_updater::LIGHTY_UPDATER;
use crate::minecraft::loaders::lighty_updater::lighty_updater::LightyQuery;
use crate::minecraft::loaders::neoforge::neoforge::{NeoForgeQuery,NEOFORGE};
use std::sync::Arc;
use crate::minecraft::loaders::quilt::quilt::{QuiltQuery,  QUILT};
use crate::minecraft::loaders::fabric::fabric::{FabricQuery,  FABRIC};
use crate::minecraft::loaders::vanilla::vanilla::{VanillaQuery,  VANILLA};
