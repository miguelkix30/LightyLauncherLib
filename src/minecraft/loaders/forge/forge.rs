use crate::minecraft::loaders::forge::forge_metadata::ForgeMetaData;
use crate::minecraft::loaders::forge::forge_metadata::ForgeVersionMeta;
use log::error;
use zip::ZipArchive;
use std::fs::File;
...
use crate::mkdir;
use crate::utils::download::download_file_untracked;
use crate::minecraft::version::version_metadata::{JavaVersion, Library, MainClass, Arguments, VersionBuilder, VersionMetaData};
use crate::minecraft::version::version::Version;
use crate::minecraft::loaders::utils::{error::QueryError, query::Query, manifest::ManifestRepository};
use crate::minecraft::loaders::vanilla::{vanilla::VanillaQuery, vanilla_metadata::VanillaMetaData};
