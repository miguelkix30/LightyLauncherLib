...
use crate::minecraft::loaders::vanilla::vanilla::VANILLA;
use crate::minecraft::loaders::fabric::fabric::FABRIC;
use crate::minecraft::loaders::quilt::quilt::QUILT;
use crate::minecraft::loaders::neoforge::neoforge::NEOFORGE;
...
pub async fn merge_metadata(version: &Version<'_>, loader: &str) -> Result<VersionBuilder> {
    ...
    let merged_metadata = match loader_metadata {
        Loader::Vanilla => {
            ...
            use crate::minecraft::loaders::vanilla::vanilla::VanillaQuery;
